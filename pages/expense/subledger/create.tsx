...
import { SubledgerCreateComponent } from '@components/generalexpense/subledger/create'
...
const SubledgerCreatePage = ({
  ...
  const createItem = async () => {
    try {
      await createOne('expense/subledger/create', formValues, token)
...
export default SubledgerCreatePage

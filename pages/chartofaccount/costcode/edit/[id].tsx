...
import { CostCodeEditComponent } from '@components/chartofaccount/costcode/edit'
...
const CostCodeEditPage = ({
  ...
  const editItem = async () => {
    try {
      await updateOne('account/costcode/edit', data._id, formValues, token)
...
export default CostCodeEditPage

...
import { RequestorCreateComponent } from '@components/requisition/requestor/create'
...
const RequestorCreatePage = ({
  ...
  const createItem = async () => {
    try {
      await createOne('requisition/requestor/create', formValues, token)
...
export default RequestorCreatePage
